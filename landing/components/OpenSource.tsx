      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tight">
            {d.openSource.title1}{" "}
            <span className="text-gradient">{d.openSource.title2}</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-12">
          {d.openSource.contributions.map((c) => (
            <div
              key={c.title}
        ...
        <h3 className="text-sm font-semibold text-white/40 uppercase tracking-widest mb-4">
          {d.openSource.packagesTitle}
        </h3>
        <div className="grid md:grid-cols-3 gap-5 mb-12">
          {d.openSource.packages.map((pkg) => (
            <div
              key={pkg.name}
            ...
            >
              ...
              <div className="text-xs text-white/40 mb-3">PyPI · v0.1.0</div>
        ...
        <div className="text-center">
          ...
          >
            ...
            {d.openSource.githubCta}
          </a>
          <p className="mt-3 text-white/35 text-sm">
            {d.openSource.licenseNote}
          </p>
        </div>
      </div>
    </section>
